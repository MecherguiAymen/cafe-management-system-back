...
import com.mechergui.cafe.POJO.Product;
import com.mechergui.cafe.constants.CafeConstants;
import com.mechergui.cafe.dao.ProductDao;
            ...
            if (jwtFilter.isAdmin()) {
                if (validateProductMap(requestMap, true)) {
                    ...
                    if (!optional.isEmpty()) {
                        ...
                        return CafeUtils.getResponseEntity("Product id doeas not exist", HttpStatus.OK);
                    }
                } else {
                    return CafeUtils.getResponseEntity(CafeConstants.INVALID_DATA, HttpStatus.BAD_REQUEST);
                }
